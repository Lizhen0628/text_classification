...
class WeiboDataset(NLPDataset):
    def __init__(self,data_path,test=False,stop_words_path=None,batch_first=False,include_lengths=False,tokenizer_language='cn'):
        """
        :param data_path:
        ...
        ,batch_first=batch_first,include_lengths=include_lengths,tokenizer_language=tokenizer_language)
